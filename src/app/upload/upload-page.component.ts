...
import { AiTaggingService, WardrobeTagResponse } from './ai-tagging.service';
...
export class UploadPageComponent implements OnDestroy {
  ...
  aiResult: WardrobeTagResponse | null = null;
  ...
  async startPipeline(blob: Blob): Promise<void> {
    ...
    try {
      ...
      this.status = 'done';
      this.statusMessage = 'Item analyzed. Tags generated by AI stylist.';
    } catch (err: any) {
